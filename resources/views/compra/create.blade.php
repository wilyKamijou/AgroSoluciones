...
@section ("contenido")
    ...
    <form action="/compra/guardar" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="date" id="ubicacion" name="fechaCo" class="form-control" placeholder="Ingrese la fecha de la compra" required>
        </div>

           <!--monto total-->
        <div class="mb-3">
            <label for="ubicacion" class="form-label">Monto total de la compra:</label>
            <input type="text" id="ubicacion" name="montoTotalCo" class="form-control" placeholder="Ingrese el monto total de la compra" required>
        </div>
