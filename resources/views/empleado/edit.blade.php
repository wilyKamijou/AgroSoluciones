...
<h2 class="text-center mb-4">Editar Datos Del Empleado</h2>
<div class="card shadow-sm p-4 mb-4">
    ...
    <form action="/empleado/{{$empleado->id_empleado}}/actualizar" method="POST" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="sueldoEm" class="form-control" value="{{$empleado->sueldoEm}}" required>
        </div>

        <!-- Telefono -->
        <div class="col-md-6">
            <label class="form-label">Teléfono</label>
            <input type="text" name="telefonoEm" class="form-control" value="{{$empleado->telefonoEm}}" required>
        </div>
